...
<main>
    ...
    <div class="blocs">
        ...
        <div class="lieu">
            ...
            <p class="fade-left">Nos fournisseurs sont sélectionnés par nos soins selon un cahier des charges strict, un savoir-faire unique et une capacité à fournir des produits de qualité tenant <br> compte d’un mode de pêche favorisant le maintien de la ressource.</p>
            <div class="bloc">
